...
NUM_CPUS  = 20 # os.cpu_count() #NUM_CPUS-1 = num_rollout_workers. to calculate the num_steps on each batch (for the cv learning)
...
class Env(MultiAgentEnv):
    def __init__(self, config_dict):
        ...
        self.accumulated_rewards = {agent: 0 for agent in self.agent_lst}     
